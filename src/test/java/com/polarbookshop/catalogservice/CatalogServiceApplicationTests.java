...
class CatalogServiceApplicationTests {
    ...
    private WebTestClient webTestClient;
	 ...
	 void whenGetRequestWithIdThenBookReturned() {
	        ...
	        var bookToCreate = new Book(null, 
	        				bookIsbn, "Title", "Author", 9.90);
	 ...
	 void whenPutRequestThenBookUpdated() {
	        ...
	        var bookToCreate = new Book(UUID.randomUUID().toString(), 
	        					bookIsbn, "Title", "Author", 9.90);
	        ...
	        var bookToUpdate = new Book(UUID.randomUUID().toString(), 
