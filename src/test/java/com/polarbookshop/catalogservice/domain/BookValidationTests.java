...
class BookValidationTests {
	...
	void whenAllFieldsCorrectThenValidationSucceeds() {
		var book = new Book(UUID.randomUUID().toString(), "1234567890", "Title", "Author", 9.90);
	...
	void whenIsbnNotDefinedThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "", "Title", "Author", 9.90);
	...
	void whenIsbnDefinedButIncorrectThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "a234567890", "Title", "Author", 9.90);
	...
	void whenTitleIsNotDefinedThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "1234567890", "", "Author", 9.90);
	...
	void whenAuthorIsNotDefinedThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "1234567890", "Title", "", 9.90);
	...
	void whenPriceIsNotDefinedThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "1234567890", "Title", "Author", null);
	...
	void whenPriceDefinedButZeroThenValidationFails() {
		var book = new Book(UUID.randomUUID().toString(), "1234567890", "Title", "Author", 0.0);
